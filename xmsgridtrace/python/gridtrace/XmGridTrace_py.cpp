...
void initXmGridTrace(py::module &m) {
    ...
    gridtrace
        ...
        //}))
          ...
          .def("get_max_tracing_time_seconds", &xms::XmGridTrace::GetMaxTracingTime, "Gets the max tracing time in seconds")
          // virtual void SetMaxTracingTimeSeconds(const double a_maxTracingTime) = 0;
          .def("set_max_tracing_time_seconds", &xms::XmGridTrace::SetMaxTracingTime, "Sets the max tracing time in seconds")
          // virtual double GetMaxTracingDistanceMeters() const = 0;
          .def("get_max_tracing_distance_meters", &xms::XmGridTrace::GetMaxTracingDistance, "Gets the max tracing distance in meters")
          // virtual void SetMaxTracingDistanceMeters(const double a_maxTracingDistance) = 0;
          .def("set_max_tracing_distance_meters", &xms::XmGridTrace::SetMaxTracingDistance, "Sets the max tracing distance in meters")
          // virtual double GetMinDeltaTimeSeconds() const = 0;
          .def("get_min_delta_time_seconds", &xms::XmGridTrace::GetMinDeltaTime, "Gets the minimum delta time")
          // virtual void SetMinDeltaTimeSeconds(const double a_minDeltaTime) = 0;
          .def("set_min_delta_time_seconds", &xms::XmGridTrace::SetMinDeltaTime, "Sets the minimum delta time")
          // virtual double GetMaxChangeDistanceMeters() const = 0;
          .def("get_max_change_distance_meters", &xms::XmGridTrace::GetMaxChangeDistance, "Gets the maximum change in distance in meters")
          // virtual void SetMaxChangeDistanceMeters(const double a_maxChangeDistance) = 0;
          .def("set_max_change_distance_meters", &xms::XmGridTrace::SetMaxChangeDistance, "Sets the maximum change in distance in meters")
          // virtual double GetMaxChangeVelocityMetersPerSecond() const = 0;
          .def("get_max_change_velocity_meters_per_second", &xms::XmGridTrace::GetMaxChangeVelocity, "Gets the maximum changee in velocity in meters per second")
          // virtual void SetMaxChangeVelocityMetersPerSecond(const double a_maxChangeVelocity) = 0;
          .def("set_max_change_velocity_meters_per_second", &xms::XmGridTrace::SetMaxChangeVelocity, "Sets the maximum changee in velocity in meters per second")
